...
const copy: Record<Locale, FooterCopy> = {
  de: {
    ...
    nav: [
      ...
      { label: 'OnlyFans Guide', href: '/ratgeber/onlyfans-guide' },
      { label: 'OnlyFans Marketing', href: '/ratgeber/onlyfans-marketing' },
      { label: 'Agentur Kosten', href: '/ratgeber/onlyfans-agentur-kosten' },
      { label: 'Fansly vs OnlyFans', href: '/ratgeber/fansly-vs-onlyfans' },
