...
import { GuidePreviewSection } from '@/components/guide-preview-section';
...
export function HomeShell({ initialLocale }: { initialLocale: Locale }) {
  ...
  return (
    <>
      ...
      />
      <main id="content">
        <HeroSection eyebrow={c.heroEyebrow} hero={c.hero} lead={c.lead} ctaLabel={c.heroButton} />
        ...
        <PhoneStage eyebrow={c.phoneEyebrow} title={c.phoneTitle} lead={c.phoneLead} badge={c.phoneBadge} sticker={c.phoneSticker} locale={locale} />
        <DashboardSection eyebrow={c.dashboardEyebrow} title={c.dashboardTitle} lead={c.dashboardLead} stages={c.dashboardStages} />
        ...
        <AboutPanel
          ...
          locale={locale}
        />
        <GuidePreviewSection locale={locale} />
